...
It is very important that you pull before a work session to ensure your local repo is up to date with the remote repo. There are ways to fix this it occurs, but will likely require help from a mentor, unless you are a git wizard 🧙.
:::
