...
## Tabs
You can also create and name custom tabs to better organize your widgets. We typically try to make a few tabs for competition and then separate the rest into debug groups. Elastic even has an API that allows you to automate switching tabs from within the robot code. Read more about ElasticLib [here](https://frc-elastic.gitbook.io/docs/customizing-your-dashboard/adding-and-customizing-widgets).
