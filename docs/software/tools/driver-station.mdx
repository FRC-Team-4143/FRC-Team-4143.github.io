...
You can quickly identify the enabled status of the robot looking at the RSL (Robot Signal Light). Flashing is enabled and solid is disabled.

The robot can only be enabled by the Driver Station (unless connected to an FMS).
