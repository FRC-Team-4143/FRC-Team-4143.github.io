...
See [Mechanisms](./mechanisms/) for more details on the interworkings of mechanims. Below is a simple example of using the indexer mechanism in the `updateLogic()` method:
```java
@Override
public void updateLogic(double timestamp) {
    switch (system_state_) {
