...
description: An overview of mechanisms and subsystems used in FRC robots. This is a unique approach compare to the traditional subsystem-based design, focusing on modular and reusable components.
