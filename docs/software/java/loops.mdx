...
```
:::info
The iterator variable can be referenced within the loop to see what iteration you are currently on. This is useful for debugging or if you want to do something special on a specific iteration. The iterator variable can also be modified within the loop, but you must be carful not to accidentally make an infinite loop. (Generally you should rethink your plan if you need to update the iterator.)
:::
