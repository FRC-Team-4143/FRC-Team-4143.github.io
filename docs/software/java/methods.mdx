...
void methodName(double param_name){
    double var_name;
    // Both param_name and var_name can be referenced here
}
// Neither param_name or var_name can be referenced here
```
:::
