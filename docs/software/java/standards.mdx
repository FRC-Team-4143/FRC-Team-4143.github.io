...
- All methods should be commented following java doc styling. Make sure to include any parameters or return members. Example is show below:
    ...
    ```
:::info JavaDoc Comments
Typing out "/**" and hitting enter above a method will automatically generate a JavaDoc comment template with that methods parameters and return values.
:::
